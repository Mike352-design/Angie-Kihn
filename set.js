...
module.exports = { session: process.env.SESSION_ID || 'Scenemd',
    ...
    GITHUB : process.env.GITHUB|| 'https://github.com/Mike352-design/Angie-Kihn',
    OWNER_NAME : process.env.OWNER_NAME || "MISTAH X",
    NUMERO_OWNER : process.env.NUMERO_OWNER || "254743634539",              
    ...
    CAPTION : process.env.CAPTION || "ᴘᴏᴡᴇʀᴇᴅ ʙʏ GRACIE-V2",
    BOT : process.env.BOT_NAME || 'GRACIE 1',
